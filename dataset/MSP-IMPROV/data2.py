...
class MSPIMPROV(Dataset):
    def __init__(self, root_dir='/home/chenchengxin/dataset/MSP-IMPROV/', mode='train'):
        self.data_info = pd.read_csv('/home/chenchengxin/spk_adaptiation_for_SER/meta/MSP-IMPROV.tsv', sep='\t')
    ...
    def get_audio_dir_path_from_meta(self, filename):
        ...
        audio_dir = os.path.join(self.root_dir, 'Audio', session, dialog, stage)
        return audio_dir        
