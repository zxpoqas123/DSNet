...
class Mydataset(Dataset):
    def __init__(self, dataset_type='IEMOCAP_4', mode='train', max_len=6, fold=0, num=0, feature_ls=['FBank'], condition='impro'):
        ...
        self.feature_root = ['/home/chenchengxin/spk_adaptiation_for_SER/dataset/{}_{}.pkl'.format(dataset_type, feature_detail_dic[feature]) for feature in feature_ls]
