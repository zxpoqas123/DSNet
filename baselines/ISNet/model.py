...
class Encoder(nn.Module):
    def __init__(self):
        super().__init__()
        self.layer1 = CNN6(80)
        self.layer2 = AttBlock(512, 128, activation='sigmoid')
...
class Translator(nn.Module):
    def __init__(self):
        super().__init__()
        self.layer1 = AttentionTransLayer(128, 128)
        self.layer2 = AttentionTransLayer(128, 64)
        self.layer3 = AttentionTransLayer(64, 128)
        self.layer4 = AttentionTransLayer(128, 128)
